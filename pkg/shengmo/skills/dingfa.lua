...
Fk:loadTranslationTable{
 ["shengmo__dingfa"]="定法",
 [":shengmo__dingfa"]="变革技，每轮开始时，你可以洗切一名角色的手牌并将《商君书》置入其手牌区中央。<br/><br/><b>《商君书》</b>：律（无类型、点数、花色）。计入手牌数，不能直接使用或打出。你不能整理手牌；以此牌为中线，当你使用任意一侧的手牌时，若该侧牌数：较多，你将牌堆顶两张牌置入较少侧并令此牌无效；较少，你弃置较多侧的一张牌并令此牌多结算一次。两侧牌数在使用前比较，不计此牌；普通获得的牌置于右侧。此牌离开初始手牌区时，改为移出游戏。",
